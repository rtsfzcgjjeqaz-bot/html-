...
export const mobileQualityGovernanceStackRegistryEntry = {
  ...
  actionBreakdownPath: "library/mac-shot-library/shot_71/docs/action-breakdown.md",
  atomicMotionsPath: "library/mac-shot-library/shot_71/runtime/atomic/shot71-atomic-motions.ts",
  choreographyPath: "library/mac-shot-library/shot_71/runtime/choreography/mobileQualityGovernanceStack.tsx",
