...
export const mobileGeneratedResultCardPopRegistryEntry = {
  ...
  actionBreakdownPath: "library/mac-shot-library/shot_40/docs/action-breakdown.md",
  atomicMotionsPath: "library/mac-shot-library/shot_40/runtime/atomic/shot40-atomic-motions.ts",
  choreographyPath: "library/mac-shot-library/shot_40/runtime/choreography/mobileGeneratedResultCardPop.tsx",
