...
export const aiRequirementComposerRegistryEntry = {
  ...
  actionBreakdownPath: "library/mac-shot-library/shot_55/analysis/action-breakdown.md",
  atomicMotionsPath: "library/mac-shot-library/shot_55/runtime/shot/shot55-atomic-motions.ts",
  choreographyPath: "library/mac-shot-library/shot_55/runtime/shot/shot55-choreography.tsx",
