...
export const dualDeviceFeatureStageRegistryEntry = {
  ...
  actionBreakdownPath: "library/mac-shot-library/shot_44/docs/action-breakdown.md",
  atomicMotionsPath: "library/mac-shot-library/shot_44/runtime/atomic/shot44-atomic-motions.ts",
  choreographyPath: "library/mac-shot-library/shot_44/runtime/choreography/dualDeviceFeatureStage.tsx",
